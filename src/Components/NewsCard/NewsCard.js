        ...
        <Card ref={elRefs[i]} className={classNames(classes.card, activeArticle === i ? classes.activeCard: null)}>
            <CardActionArea href={url} target="_blank">
                ...
                <div className={classes.details}>
                    ...
                    <Typography className={classes.title} varient="body2" component="h6">{title}</Typography>
                <CardContent>
                    <Typography varient="body2" color="textSecondary" component="h5">{description}</Typography>
                </CardContent>
            </CardActionArea>
